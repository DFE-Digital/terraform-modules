...
| <a name="input_site_config"></a> [site\_config](#input\_site\_config) | The site configuration for the Web App. | <pre>object({<br/>    application_stack = optional(object({<br/>      dotnet_version = optional(string)<br/>      java_version   = optional(string)<br/>    }))<br/>  })</pre> | `{}` | no |

...
```terraform
module "storage" {
  source = "git::https://github.com/DFE-Digital/terraform-modules.git//azure/storage_account?ref=stable"
...
A module call to create a **private** storage account requires 1 override and network settings:-
...
```
  ...
  dnszone_name                  = module.network.storage_privdns_name # "privatelink.blob.core.windows.net"

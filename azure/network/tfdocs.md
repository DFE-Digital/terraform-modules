...
|------|-------------|------|---------|:--------:|
| <a name="input_apps_subnet"></a> [apps\_subnet](#input\_apps\_subnet) | n/a | `list` | <pre>[<br/>  "10.3.0.0/18"<br/>]</pre> | no |
...
| <a name="input_sql_subnet"></a> [sql\_subnet](#input\_sql\_subnet) | n/a | `list` | <pre>[<br/>  "10.2.192.0/18"<br/>]</pre> | no |

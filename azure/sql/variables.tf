...
variable "firewall_rules" {
  type        = list(object({ name = string, ip_address = optional(string), start_ip_address = optional(string), end_ip_address = optional(string) }))
  default     = []
  description = "List of firewall rules to create for the SQL logical server. Each rule is an object with name, start_ip_address, and end_ip_address."
}

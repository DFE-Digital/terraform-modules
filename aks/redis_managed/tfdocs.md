...
| <a name="input_azure_maxmemory_policy"></a> [azure\_maxmemory\_policy](#input\_azure\_maxmemory\_policy) | Specifies how Redis decides which data to remove when it runs out of memory | `string` | `"VolatileLRU"` | no |
